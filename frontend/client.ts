 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { createService as api_service_create_service_createService } from "~backend/service/create_service";
import { getService as api_service_get_service_getService } from "~backend/service/get_service";
import { listServices as api_service_list_services_listServices } from "~backend/service/list_services";
import { updateService as api_service_update_service_updateService } from "~backend/service/update_service";
...
export namespace service {
    ...
    export class ServiceClient {
         ...
         */
        public async createService(params: RequestType<typeof api_service_create_service_createService>): Promise<ResponseType<typeof api_service_create_service_createService>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/service/create`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_service_create_service_createService>
        }

        /**
         * Gets a service by service code.
         */
        public async getService(params: { serviceCode: string }): Promise<ResponseType<typeof api_service_get_service_getService>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/service/${encodeURIComponent(params.serviceCode)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_service_get_service_getService>
        }

        /**
         * Lists all service requests.
         */
        public async listServices(): Promise<ResponseType<typeof api_service_list_services_listServices>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/service/list`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_service_list_services_listServices>
        }

        /**
         * Updates a service request.
         */
        public async updateService(params: RequestType<typeof api_service_update_service_updateService>): Promise<ResponseType<typeof api_service_update_service_updateService>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/service/update`, {method: "PUT", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_service_update_service_updateService>
        }
    }
}

...
```bash
git remote add encore encore://computer-repair-shop-pb22
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/computer-repair-shop-pb22/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/computer-repair-shop-pb22/settings/integrations/github)
